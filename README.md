...
The $\Lambda$CDM model faces a major challenge on galactic scales known as the Cusp-Core problem. Standard N-body simulations predict steep dark matter profiles (cusps) that are observationally contradicted by the flat cores observed in low surface brightness galaxies.
